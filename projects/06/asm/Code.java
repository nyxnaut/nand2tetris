public class Code {
  public static final String dest() throws ParsingException {
    switch (Parser.dest()) {
      case    "M": return "001";
      case    "D": return "010";
      case   "MD": return "011";
      ...
      default: throw new ParsingException("destination not found");
    }
  }

  public static final String comp() throws ParsingException {
    switch (Parser.comp()) {
      ...
      default: throw new ParsingException("comp not found");
    }
  }

  public static final String jump() throws ParsingException {
    switch (Parser.jump()) {
      case "JGT": return "001";
      case "JEQ": return "010";
      case "JGE": return "011";
      ...
      case "JMP": return "111";
      case "null": return "000";
      default: throw new ParsingException("jump not found");
    }
  }
}